...
import { updateStudentFail, updateStudentStart, updateStudentSuccess } from '../redux/principal/principalSlice';
...
const UpdateClass = () => {
    ...
    const updateStudent =async(e)=>{
       ...
       try {
        ...
        const res = await fetch(`/api/v1/updateStudent/${id}`, {
          method: 'PUT',
          headers: {
        ...
        dispatch(updateStudentFail(error.message));
